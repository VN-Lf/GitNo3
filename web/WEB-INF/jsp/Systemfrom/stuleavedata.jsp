...
<body id="kaohe" class="easyui-layout">
    <div data-options="region:'center'">
        <form style="width: 1205px;margin: 20px 0px 0px 20px">
            学生姓名:<input type="text" name="empname" id="empname" required lay-verify="required" placeholder="请输人姓名"  class="layui-input" style="width:180px;display:inline-block" />
        ...
        <script type="text/html" id="toolbarDemo">
            <div class="layui-btn-container" style="float: left">
                <button class="layui-btn layui-btn-warm layui-btn-sm" lay-event="backstuleave">返回图表</button>
            </div>
        </script>
...
<script type="text/javascript">
    layui.use(['table','form'], function(){
        ...
        table.render({
            ...
            ,toolbar: '#toolbarDemo'
            ,method:'post'
            ,url: '${pageContext.request.contextPath}/System/stuleavedatalist' //数据接口
            ,page: true //开启分页
            ,cols: [[ //表头
                {field: 'jobId', title: '请假编号', sort: true}
                ,{field: 'stuName', title: '学生姓名'}
                ,{field: 'studId', title: '学生编号'}
        ...
        table.on('row(test)', function(obj){
            ...
            ortherInf(leavedata.studId);
            open=true;
        });

        function ortherInf(studId) {
            if(open==false){
        ...
        function load(studId) {
            document.getElementById("east").innerHTML =
                '<object type="text/html" data="${pageContext.request.contextPath}/System/stuleadata?id='+studId+'" width="100%" height="100%"></object>';
        }

        function leave() {
            document.getElementById("kaohe").innerHTML =
                '<object type="text/html" data="${pageContext.request.contextPath}/System/tostuleave" width="100%" height="100%"></object>';
        }
        //条件搜索
        $('#selectexam').click(function () {
            ...
            table.reload('demo',{
                url:'${pageContext.request.contextPath}/System/stuleavedatalist',
                where:{
                    empname:empname,
                    month:month,
                },page:{
