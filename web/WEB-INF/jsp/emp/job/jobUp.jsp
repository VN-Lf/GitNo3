...
<body>
<form class="layui-form" method="post" action="/emp/jobUp" lay-filter="gg">
    <input type="hidden" name="empHisId">
...
<script>
    layui.use(['form','laydate'], function(){
        ...
        form.val("gg",{
            "empHisId":"${eh.empHisId}"
            ,"empId":"${eh.empId}"
            ,"empHisCompany":"${eh.empHisCompany}"
            ,"empHisDegree":"${eh.empHisDegree}"
            ,"empHisStartDay":"${eh.empHisStartDay}"
            ,"empHisEndDay":"${eh.empHisEndDay}"
            ,"empLiftReason":"${eh.empLiftReason}"
            ,"empHisRemark":"${eh.empHisRemark}"
        })
