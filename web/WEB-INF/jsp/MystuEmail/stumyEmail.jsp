    ...
    <script>
        ...
        layui.use('table', function(){
            ...
            table.render({
                ...
                ,height: 312
                ,toolbar: '#toolbarDemo'
                ,url: '${pageContext.request.contextPath}/stuemail/obtainEmail' //数据接口
                ,page: true //开启分页
                ,cols: [[ //表头-
                    {type:'checkbox'}//复选框
                    ...
                    ,{field: 'image', title: '下载文件',templet:function (data) {
                        if(data.image == null || data.image<100){
                            return '未收到文件'
                        }
            ...
            table.render({ //我收 到的邮件
                ...
                ,height: 312
                ,toolbar: '#toolbarDemo'
                ,url: '${pageContext.request.contextPath}/stuemail/SendEmail' //数据接口
                ,page: true //开启分页
                ,cols: [[ //表头
                    {type:'checkbox'}//复选框
                    ,{field: 'emailId', title: '编号', width:80, sort: true}
            ...
            table.on('tool(test)', function(obj){
                ...
                if(obj.event === 'selectedit'){
                    ...
                    var kaohuid = data.oldFileName;
                    window.location.href="<%=request.getContextPath()%>/stuemail/toemailServlet?emailId="+emailId+"&kaohuid="+kaohuid;
                }else if(obj.event === 'edit'){
                    var emailId = data.emailId;
                    window.location.href="<%=request.getContextPath()%>/stuemail/againEmail?emailId="+emailId;
                }
            });

        });
        function fans() {
            window.location.href="<%=request.getContextPath()%>/stuemail/toemailadd";
        }
