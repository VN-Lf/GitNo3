    ...
    <div data-options="region:'center',title:'信息管理'" style="background:#eee;" >
        <div style="text-align: center">
            ...
            <c:if test='${emalilist.topic=="考核"}'>
                <form style="height: 400px;width: 500px;margin-left: 580px;" action="${pageContext.request.contextPath}/stuemail/examscore" method="post" >
                    <input type="hidden" name="empkaohuid" value="${emalilist.oldFileName}">
                        ...
                        <table border="1px" style="width: 400px;height: 400px;text-align: center">
                            ...
                            <tr>
                                <td colspan="2"><div class="layui-btn-container">
                                    ...
                                    <a class="layui-btn layui-btn layui-btn-lg layui-btn-primary" href="${pageContext.request.contextPath}/stuemail/toemail"  >返回</a>
                                </div></td>
