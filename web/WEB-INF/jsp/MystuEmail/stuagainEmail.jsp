...
<div class="easyui-layout" data-options="fit:true" >
    <div data-options="region:'center',title:'信息管理'" style="background:#eee;" >
        <form action="<%=request.getContextPath()%>/stuemail/sendEmail"  enctype="multipart/form-data" id="addDor" method="post" style="width: 1205px;margin: 20px 0px 0px 10px">
...
<script>
    ...
    jQuery.noConflict();
    function close1 () {
        window.location.href="<%=request.getContextPath()%>/stuemail/toemail";
    }
    function add() {
        $("#addDor").form("submit",{
            success : function () {
    ...
    $(function () {
        ...
        $("#deptId").change(function () {
            ...
            $.ajax({
                url : "<%=request.getContextPath()%>/stuemail/selsendEmail",
                type: "post",
                data :{
                    deptname :deptId
                },
